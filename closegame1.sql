...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 25 2026 г., 16:01
...
(5, 2, '2026-05-25 04:50:19', '2026-05-25 04:50:19');
...
(39, 5, 12, 1, '2026-05-25 04:50:25', '2026-05-25 04:50:25'),
(40, 1, 19, 1, '2026-05-25 05:26:10', '2026-05-25 05:26:10');
...
(10, '2026_05_24_153016_create_orders_table', 6),
(11, '2026_05_24_153039_create_order_items_table', 6),
(12, '2026_05_25_093740_add_is_banned_to_users_table', 7);
...
CREATE TABLE `orders` (
  ...
  `steam_login` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `orders` (`id`, `user_id`, `status`, `total_amount`, `payment_method`, `steam_login`, `created_at`, `updated_at`) VALUES
(2, 2, 'processing', 3999, 'card', 'test', '2026-05-25 03:38:08', '2026-05-25 04:49:46'),
(3, 2, 'cancelled', 1000, 'sbp', 'test', '2026-05-25 04:11:15', '2026-05-25 04:49:42'),
(4, 2, 'completed', 1000, 'card', '123123', '2026-05-25 04:23:21', '2026-05-25 04:34:46');
...
INSERT INTO `order_items` (`id`, `order_id`, `game_id`, `title`, `price`, `quantity`, `sum`, `created_at`, `updated_at`) VALUES
(1, 2, 9, 'Battlefield 6', 2999, 1, 2999, '2026-05-25 03:38:08', '2026-05-25 03:38:08'),
(2, 2, 11, 'Hollow Knight: Silksong', 1000, 1, 1000, '2026-05-25 03:38:08', '2026-05-25 03:38:08'),
(3, 3, 11, 'Hollow Knight: Silksong', 1000, 1, 1000, '2026-05-25 04:11:15', '2026-05-25 04:11:15'),
(4, 4, 11, 'Hollow Knight: Silksong', 1000, 1, 1000, '2026-05-25 04:23:21', '2026-05-25 04:23:21');
...
(11, 2, NULL, '123123', '123123', 'answered', '2026-05-25 05:37:03', '2026-05-25 05:37:14');
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `is_admin`, `is_banned`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'admin', 'admin@mail.ru', '$2y$12$jFNoo/xmQyx7fm/ABMzHWu201glMJ7SFX8ZSDEfiLHCp7ztfcCMZO', 1, 0, 'lb5ghZG3V18wJmPnsCmOGF3hjfLRaIx6l0yqTd5hMapuDWk4VbMrGMv9ChsG', '2025-11-21 06:26:57', '2025-11-21 06:26:57'),
(2, 'test', 'test@examole.com', '$2y$12$8Lg0IQQCYLnDde3960J.VeGhA/kBLDb5lhs8VE5JGKXDYq3c5SrLO', 0, 0, 'sMnzYooxmNj287KuMN75nqF07HM27NKBySGEj32JOXnK1mYzM2RfzO5xQ135', '2025-11-21 09:42:59', '2025-11-21 09:42:59'),
(3, 'Maksik', 'Maksik@mail.ru', '$2y$12$GjDQgQ2i83v4RwpRmawzke1YmioATzySpa.KI9tlSSUAd9u8wxm.6', 0, 0, NULL, '2025-11-25 02:07:36', '2025-11-25 02:07:36'),
(4, 'Kirill', 'kirill@mail.ru', '$2y$12$T8CfthV8gP8AzT0l2pmC0OxthIBLV5Mh5DZWGU6WcGu4tM7z37azi', 0, 0, NULL, '2026-05-25 04:38:56', '2026-05-25 04:46:49');
