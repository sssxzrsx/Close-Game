    ...
    <div class="slider">
        <div class="slides">
            <div class="slide active">
                <img src="{{ asset('storage/images/' . 'slide 1.jpg') }}" alt="BATTLEFIELD 6">
                <a href="{{ route('catalog.show', 11) }}" class="btn-more">
                    Подробнее</a>
            </div>
            <div class="slide">
                <img src="{{ asset('storage/images/' . 'slide 2.jpg') }}" alt="HELLDIVERS 2">
                <a href="{{ route('catalog.show', 19) }}" class="btn-more">
                    Подробнее</a>
            </div>
            <div class="slide">
                <img src="{{ asset('storage/images/' . 'slide 3.jpg') }}" alt="Forza Horizen 5">
